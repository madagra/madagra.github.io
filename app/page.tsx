    ...
    <>
      <section className="hero shell">
        <div className="hero-copy">
          ...
          <h1>Building useful technology at the edge of science.</h1>
          <p className="lede">I’m Mario Dagrada, an engineering leader and AI consultant based in Eindhoven, the Netherlands.</p>
          <div className="actions"><Link className="button" href="/projects">Explore projects</Link><a className="text-link" href="/assets/files/20240125_CV_Dagrada_scidev.pdf">Download CV</a></div>
        </div>
